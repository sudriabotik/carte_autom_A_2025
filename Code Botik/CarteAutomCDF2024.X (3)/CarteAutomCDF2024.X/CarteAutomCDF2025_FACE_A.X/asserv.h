 ...
 * @param x0 : en mm (= NAN pour ne pas l'initialiser)
 * @param y0 : en mm (= NAN pour ne pas l'initialiser)
 * @param teta0 : en degré (= NAN pour ne pas l'initialiser)
 */
