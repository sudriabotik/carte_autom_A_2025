...
double get_Y (void)
{
    return ROBOT.Y_mm; // sans inv couleur lol
}

double get_orientation (void)
{
    return ROBOT.orientation_degre;// sans inv couleur lol
}
