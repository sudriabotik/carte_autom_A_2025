...
/**
 * Timer d'autom : 20 ms
 * D?compte relanc? ? la fin de la fonctions -> temps non fiable
 * UNSFAE : fonction bloquante autoris?e
 */
...
/**
 *  Timer 200 ms : Liaison s?rie
 *  UNSAFE : Fonction bloquante autoris?e
 */
 ...
 *        D?tecte, par exemple, endSwitch1 sur front montant.
 */
