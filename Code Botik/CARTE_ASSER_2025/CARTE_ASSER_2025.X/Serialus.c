...
#endif
#ifdef ARDUINO
    serialus_traitement_arduino(0);                //dans ce mode, seul les instaruction de l'arduino sont prises en compte
}  
#endif
 ...
 */
void serialus_traitement_arduino(int pos)
{
    //  les chaines doivent-être les plus courte possible pour limité le temps de transmision
    if (check_string(pos, "test"))
    {
        delay_ms(100);
        printf("P");
        delay_ms(1000);
